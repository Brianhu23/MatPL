...
# 打包最终的脚本
tar -czvf matpl_cpu-2025.3.sh.tar.gz matpl_cpu-2025.3.sh check_offenv_cpu.sh packtime-$timestamp
...
# copy to /share
cp md5.txt matpl_cpu-2025.3.sh.tar.gz.part_* /share/public/PWMLFF_test_data/matpl-pack/2025.3-cpu-v2
